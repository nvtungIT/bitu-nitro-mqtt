...
/**
 * Represents the JavaScript callback `(topic: string, message: string) => void`.
...
class Func_void_std__string_std__string {
  @DoNotStrip
  @Keep
   ...
   */
  fun toLambda(): (topic: String, message: String) -> Unit = this::call
   ...
   */
  @FastNative
  external fun call(topic: String, message: String): Unit
}
