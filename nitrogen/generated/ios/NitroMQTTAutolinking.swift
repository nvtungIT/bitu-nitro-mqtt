///
/// NitroMQTTAutolinking.swift
/// This file was generated by nitrogen. DO NOT MODIFY THIS FILE.
/// https://github.com/mrousavy/nitro
/// Copyright © 2024 Marc Rousavy @ Margelo
///

public final class NitroMQTTAutolinking {
   ...
   */
  public static func createMath() -> bridge.std__shared_ptr_margelo__nitro__mqtt__HybridMathSpec_ {
    let hybridObject = HybridMath()
    return { () -> bridge.std__shared_ptr_margelo__nitro__mqtt__HybridMathSpec_ in
      let __cxxWrapped = HybridMathSpecCxx(hybridObject)
      let __pointer = HybridMathSpecCxxUnsafe.toUnsafe(__cxxWrapped)
      return bridge.create_std__shared_ptr_margelo__nitro__mqtt__HybridMathSpec_(__pointer)
    }()
  }
   ...
   */
  public static func createMQTT() -> bridge.std__shared_ptr_margelo__nitro__mqtt__HybridMQTTSpec_ {
    let hybridObject = HybridMQTT()
    return { () -> bridge.std__shared_ptr_margelo__nitro__mqtt__HybridMQTTSpec_ in
      let __cxxWrapped = HybridMQTTSpecCxx(hybridObject)
      let __pointer = HybridMQTTSpecCxxUnsafe.toUnsafe(__cxxWrapped)
      return bridge.create_std__shared_ptr_margelo__nitro__mqtt__HybridMQTTSpec_(__pointer)
    }()
  }
}
